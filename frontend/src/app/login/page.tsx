...
import { PlaneTakeoff, AlertCircle, ShieldCheck } from "lucide-react";
      ...
      <div className="relative z-10 w-full max-w-md animate-in fade-in zoom-in-95 duration-500">
        <div className="glass-panel p-10 rounded-[32px] shadow-2xl border-t border-white/10 relative overflow-hidden group">
          ...
          <div className="flex flex-col items-center mb-10 text-center">
            ...
            <h1 className="text-3xl font-bold text-white tracking-tight mb-2">Welcome to ZUno</h1>
            <p className="text-white/40 text-sm font-medium">Elevate your travel logistics with precision.</p>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2 group/input">
                <div className="flex items-center justify-between ml-1">
                  <label
                    htmlFor="password"
                    className="text-[10px] font-bold uppercase tracking-widest text-primary group-focus-within/input:text-secondary transition-colors"
                  >
                    Password
                  </label>
                  <Link
                    href="#"
                    className="text-[10px] font-bold uppercase tracking-widest text-white/20 hover:text-primary transition-colors"
                  >
                    Forgot?
                  </Link>
                </div>
          ...
          <div className="mt-10 text-center text-[11px] font-bold uppercase tracking-widest">
            <span className="text-white/20">New explorer?</span>{" "}
            <Link href="/register" className="text-primary hover:text-secondary transition-colors ml-1">
              Create Account
            </Link>
          </div>
        </div>
